...
app.controller('featuredCtrl', function($scope) {
  $scope.articles = [
    ...
    },
    {
      ...
      description:"Latin American markets had a spectacular 2003, and investors say the good times will continue in 2004 in some economies as growth accelerates and household income rises. Underpinning that growth is the rise in women's work and wages.",
      link:"#",
      className:"business",
      page:"business.html",
      imageClass:"inh"
    ...
    },
    {
      ...
      description:"Several countries are picking away at California's strength in the U.S. wine market, but Argentina, courtesy of some of the lowest costs in the business and rising quality standards, is making the greatest gains globally.",
      link:"#",
      className:"business",
      page:"business.html",
      imageClass:"inh"
